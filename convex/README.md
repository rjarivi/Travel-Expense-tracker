...
- Cloud URL: https://majestic-fish-796.convex.cloud
- HTTP Actions URL: https://majestic-fish-796.convex.site
...
3. Verify endpoints:
   ...
   - GET  https://majestic-fish-796.convex.site/expenses/load?tripKey=test
